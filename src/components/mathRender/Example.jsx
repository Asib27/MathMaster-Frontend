...
const Example = ({
  ...
  const getRadio = (state, i) => {
    if (state === 'correct' && i === selected) { return ' bg-green-500 border-2 border-green-500 ' } else if (state === 'incorrect' && i === selected) { return ' bg-red-500 border-2 border-red-500 ' } else if (state === 'incorrect' && i === correct) { return ' bg-green-500 border-2 border-green-500 ' } else if (state === 'selected' && i === selected) { return ' bg-blue-gray-500 border-2 border-blue-gray-500 ' } else return ' border-2 border-blue-gray-400 '
  }
